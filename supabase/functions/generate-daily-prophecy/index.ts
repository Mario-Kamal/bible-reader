...
1. اكتب النص الكامل لآيات النبوة من العهد القديم بالعربية (ترجمة فاندايك / البيروتية) - اكتب كل الآيات المتعلقة بالنبوة وليس آية واحدة فقط. مثلاً إذا كانت النبوة في إشعياء 53:3-7 اكتب كل الآيات من 3 إلى 7.
2. اكتب النص الكامل لآيات التحقيق من العهد الجديد بالعربية - اكتب كل الآيات المتعلقة بالتحقيق وليس آية واحدة فقط.
  ...
  "verses": [
    {
      ...
      "verse_text": "نص الآيات الكامل بالعربية - كل الآيات من البداية للنهاية"
    }
  ]
}

مهم جداً: 
- ضع آيات العهد القديم (النبوة) أولاً ثم آيات العهد الجديد (التحقيق).
- اكتب كل الآيات المتعلقة بالنبوة وبالتحقيق كاملة، وليس آية واحدة فقط. إذا كانت النبوة تتضمن عدة آيات متتالية، اكتبها كلها في verse_text واحد مع ضبط verse_start و verse_end.
- يمكن أن يكون عدد الآيات من 2 إلى 8 حسب طول النبوة والتحقيق.`;
